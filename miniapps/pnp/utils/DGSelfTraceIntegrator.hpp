...
/** Integrator for the DG form:
    ...
    * sigma = +1, kappa > 0: non-symmetric interior penalty (NIPG) method,
    * sigma = +1, kappa = 0: the method of Baumann and Oden. */
class DGDiffusionSymmetryIntegrator : public BilinearFormIntegrator
{
protected:
    Coefficient *Q;
    MatrixCoefficient *MQ;
...
/** Integrator for the DG form:
    ...
    * sigma = +1, kappa > 0: non-symmetric interior penalty (NIPG) method,
    * sigma = +1, kappa = 0: the method of Baumann and Oden. */
class DGDiffusionPenaltyIntegrator : public BilinearFormIntegrator
{
protected:
    Coefficient *Q;
    MatrixCoefficient *MQ;
...
public:
    ProteinWaterInterfaceIntegrator(Coefficient* q_, VectorCoefficient* w_, Mesh* mesh_, int protein, int water)
        : q(q_), w(w_), mesh(mesh_), protein_marker(protein), water_marker(water) {}
    ~ProteinWaterInterfaceIntegrator() {}
